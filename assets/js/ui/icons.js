/**
 * Inline SVG icon set (24×24 stroke icons, Lucide-style geometry).
 * Inlined rather than loaded from a CDN so the UI has no icon-font flash
 * and works with zero network requests.
 */
...
const PATHS = {
  ...
  family:
    '<path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/><circle cx="10" cy="7" r="3"/><path d="M21 21v-4a3 3 0 0 0-3-3"/><circle cx="18" cy="8" r="2"/>',
  clipboard:
  ...
  aid:
    '<path d="M20 12v9H4v-9"/><rect width="20" height="5" x="2" y="7" rx="1"/><path d="M12 21V7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/>',
  building:
  ...
  /* chevrons + arrows (logical, flipped for RTL by the caller) */
  ...
  accessibility:
    '<circle cx="16" cy="4" r="1"/><path d="m18 19 1-7-5.87.94"/><path d="m5 8 3-3 5.5 3-2.21 3.1"/><path d="M4.24 14.48a5 5 0 0 0 6.88 6"/>',
  briefcase:
  ...
  inboxEmpty: '<path d="M20 6H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2"/><path d="M2 12h5l2 3h6l2-3h5"/>',
  logo: '<path d="M3.5 21 14 3"/><path d="M20.5 21 10 3"/><path d="M15.5 21 12 15l-3.5 6"/><path d="M2 21h20"/>',
};
...
export function icon(name, { size = 20, className = '', strokeWidth = 1.75 } = {}) {
  ...
  return (
    ...
    `stroke-linejoin="round" aria-hidden="true" focusable="false"${className ? ` class="${className}"` : ''}>` +
    `${path}</svg>`
  );
}
